...
public class TSBHashTableDA<K,V> implements Map<K,V>, Cloneable, Serializable
{
     ...
     */
    /*
     * "? extends K" significa que, no importa con que tipo de clave creaste el Map.Entry,
     * tiene que poder ser casteable al tipo de clave K de este Map de la TSBHashtable. Lo mismo con el value.
    */
    ...
    private int search_for_entry_index(K key)
    {
        ...
        for (int j = 0; ;j++)
        {
            ...
            {
                if (entrada.getKey().equals(key)) // las keys son las mismas.
                {
